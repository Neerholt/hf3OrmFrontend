<template>
<div>
  <ul class="flex border-b p-px-10">
    <li class="-mb-px mr-1">
      <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold" href="#">Kunder</a>
    </li>
    <li class="mr-1">
      <a class="bg-white inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#">Produkt</a>
    </li>
    <li class="mr-1">
  ...
  <table class="w-full whitespace-nowrap">
    ...
    <tbody id="insertionPoint">
      <tr v-for="product in products" :key="product.id" class="bg-emerald-200">
        ...
        <td class="border px-6 py-4"><button><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
